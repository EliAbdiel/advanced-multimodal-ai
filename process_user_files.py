...
async def process_audio(file: cl.File, user_message: str) -> str:
    ...
    answer_chain = await chain.ainvoke({"text": user_message, "audio": encoded_audio})
...
async def handle_attachment(user_message: cl.Message) -> None:
    ...
    if pdf_files:
        ...
        if user_message.content:
            ...
            user_message = "Give me a description"
        file = image_files[0]
        ...
        if user_message.content:
            ...
            user_message = "Give me a description"
        file = audio_files[0]
        chain = await process_audio(file=file, user_message=user_message)
        cl.user_session.set("chain", chain)
